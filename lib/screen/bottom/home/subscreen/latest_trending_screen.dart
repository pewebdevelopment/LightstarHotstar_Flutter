...
class LatestTrendingScreen extends StatelessWidget {
  @override
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                image: DecorationImage(
                  image: AssetImage(ImageConst.latest),
                  fit: BoxFit.cover,
                ),
              ),
              child: Stack(
                      ...
                      Padding(
                        ...
                        child: Row(
                          children: [
                            ...
                            Spacer(),
                            SvgPicture.asset(ImageConst.arrowsOutSimple)
                          ],
                        ),
                      ),
                      SvgPicture.asset(ImageConst.playIcon),
                      SvgPicture.asset(ImageConst.moviePlayImage)
                    ],
                  )
                ],
              ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              commonLatestTrendingRow(text: "Video Quality",onTap: (){
                movieVideoQualityBottomSheet();
              },subText: "Auto"),
              SizedBox(
                height: 18,
              ),
              commonLatestTrendingRow(text: "Audio Language",onTap: (){
                audioLanguageBottomSheet();
              },subText: "Hindi"),
              SizedBox(
                height: 18,
              ),
              commonLatestTrendingRow(text: "Subtitles",onTap: (){
                subtitleBottomSheet();
              },subText: "English"),
              SizedBox(
                height: 18,
              ),
              commonLatestTrendingRow(text: "Report an Issue",onTap: (){
